package drawers.oval_drawers;

import Utils.OvalDrawer;
import Utils.PixelDrawer;

import java.awt.*;

public class BresenhamOvalDrawer implements OvalDrawer {

    private PixelDrawer pd;
    private Color c;

    public BresenhamOvalDrawer(PixelDrawer pd) {
        this.pd = pd;
        this.c = Color.BLACK;
    }
    ...
    @Override
    public void drawOval(int x, int y, int r, int R) {
